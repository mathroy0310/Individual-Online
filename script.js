class Slider {
    constructor() {
      ...
      this.clock = null;
      this.camera = null;
  //images de BAckgrounds
      this.images = [
      'https://i.imgur.com/lfyXFOx.png',
      'https://i.imgur.com/wcjUjot.png',
      'https://i.imgur.com/Ai1l0ql.jpg'];
...
//load les textures avec THREE.TextureLoader
    loadTextures() {
